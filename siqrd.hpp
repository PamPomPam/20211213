...
namespace siqrd {
    ...
    public:
        LSE(ublas::matrix<Precision> observations, Precision T) : observations_(observations), \
            T_(T), N1_(observations.size1()), N2_((N1_-1) * 8), K_(observations.size2()), \
        ...
        Precision operator()(Inputvector const& p) {
            ...
            for (size_t i = 0; i < N1_; ++i) {
                ...
                total += std::pow(ublas::norm_2(observ - simul), 2) * multiplication_constant_;
    ...
    private:
        //typename ublas::matrix<Precision>::size_type N1_;
        //typename ublas::matrix<Precision>::size_type N2_;
        //typename ublas::matrix<Precision>::size_type K_;
        size_t N1_;
        size_t N2_;
        size_t K_;
        Precision T_;
